...
##########
	...
	* Two goals of the presentation:
		1. Walk away with an immediately-applicable (and not overwhelming) new skill (using Git with the SmartGit GUI (and a word-wrapping diff viewer (Meld for Linux + KDiff3 for Windows + ___ for OSX), with enough knowledge to use the RefLog if necessary).
...
* A copy of the complete presentation is at [http://links.AdUnumDatum.org?time-travel-for-academics-2015-07-18](http://links.AdUnumDatum.org?time-travel-for-academics-2015-07-18)

## Goals

1. Immediately-applicable skill with one new tool (**SmartGit**, supplemented with the command line)
1. Excitement about (but not yet usable understandign of) other tools:
	* **RMarkdown**
...
* **One take-home message of everything after this:** SmartGit can do (pretty much) everything that the command line can. But it's easier to learn about this in parallel with the command line.
